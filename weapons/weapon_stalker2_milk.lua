...
SWEP.PrintName = "Condensed Milk"
SWEP.Author = "Craft_Pig"
SWEP.Purpose = 
[[
Heals 15 HP Over 1.6s
]]
...
SWEP.ViewModel = "models/weapons/sweps/stalker2/milk/v_item_milk.mdl"
SWEP.WorldModel = "models/weapons/sweps/stalker2/milk/w_item_milk.mdl"
SWEP.UseHands = true
...
local INI_AUX = false
local ID_WEAPON = "weapon_stalker2_milk"
local ID_PRIMARYAMMO = "milk"
...
function SWEP:Heal(owner)
	if IsValid(owner) and owner:GetActiveWeapon():GetClass() == ID_WEAPON then
		...
		if INI_SEF == true and SERVER then
			owner:ApplyEffect("Healing", 1.6, 1, 0.1)
		end
